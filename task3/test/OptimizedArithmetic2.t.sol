...
import {OptimizedArithmetic2} from "../src/OptimizedArithmetic2.sol";

contract OptimizedArithmetic2Test is Test {
    OptimizedArithmetic2 public arithmetic;

    function setUp() public {
        arithmetic = new OptimizedArithmetic2();
    }
    ...
    function test_DivideByZero() public {
        vm.expectRevert(OptimizedArithmetic2.DivisionByZero.selector);
